...
static void test_the_sound_for_3_is_pling(void) { check_convert_drops(3, "Pling"); }

static void test_the_sound_for_5_is_plang(void) { check_convert_drops(5, "Plang"); }

static void test_the_sound_for_7_is_plong(void) { check_convert_drops(7, "Plong"); }
...
static void
test_2_to_the_power_3_does_not_make_a_raindrop_sound_as_3_is_the_exponent_not_the_base(void) {
...
static void test_the_sound_for_105_is_plangplangplong_as_it_has_factor_3_5_and_7(void) {
...
int main(void) {
    ...
    RUN_TEST(test_the_sound_for_105_is_plangplangplong_as_it_has_factor_3_5_and_7);
