...
static void test_follow_series_of_instructions_moving_east_and_north_from_README(void) {
...
int main(void) {
    ...
    RUN_TEST(test_follow_series_of_instructions_moving_east_and_north_from_README);
