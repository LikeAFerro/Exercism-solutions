...
static void test_subtract(clock_t expected, int hour, int minute, int minute_subtract) {
    clock_t actual = clock_create(hour, minute);
    actual = clock_subtract(actual, minute_subtract);
    TEST_ASSERT_EQUAL_STRING(expected.text, actual.text);
}

static void test_compare(bool expected, int a_hour, int a_minute, int b_hour, int b_minute) {
...
static void test_compare_clocks_with_negative_hour_that_wraps_multiple_times(void) {
...
static void test_compare_clocks_with_negative_minute_that_wraps_multiple_times(void) {
