...
static void test_single_digit_strings_can_not_be_valid(void) { TEST_ASSERT_FALSE(luhn("1")); }

static void test_a_single_zero_is_invalid(void) { TEST_ASSERT_FALSE(luhn("0")); }
...
static void test_a_valid_Canadian_SIN(void) { TEST_ASSERT_TRUE(luhn("055 444 285")); }

static void test_invalid_Canadian_SIN(void) { TEST_ASSERT_FALSE(luhn("055 444 286")); }

static void test_invalid_credit_card(void) { TEST_ASSERT_FALSE(luhn("8273 1232 7352 0569")); }
...
static void test_valid_string_with_a_non_digit_added_at_the_end_to_become_invalid(void) {
...
static void test_single_zero_with_space_is_invalid(void) { TEST_ASSERT_FALSE(luhn(" 0")); }

static void test_more_than_a_single_zero_is_valid(void) { TEST_ASSERT_TRUE(luhn("0000 0")); }
...
static void test_non_numeric_non_space_char_in_middle_with_sum_divisible_by_10_isnt_allowed(void) {
