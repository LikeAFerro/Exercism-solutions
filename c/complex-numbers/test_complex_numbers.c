...
static void test_absolute_value_of_a_purely_imaginary_number_with_positive_imaginary_part(void) {
...
static void test_absolute_value_of_a_purely_imaginary_number_with_negative_imaginary_part(void) {
    complex_t z = {.real = 0.0, .imag = -5.0};
...
static void test_complex_conjugate_of_a_number_with_real_and_imaginary_part(void) {
...
static void test_exponential_resulting_in_number_with_real_and_imaginary_part(void) {
