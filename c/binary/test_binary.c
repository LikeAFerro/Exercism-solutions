...
static void test_binary_0_is_decimal_0(void) { TEST_ASSERT_EQUAL(0, convert("0")); }
...
static void test_binary_10_is_decimal_2(void) { TEST_ASSERT_EQUAL(2, convert("10")); }

static void test_binary_11_is_decimal_3(void) { TEST_ASSERT_EQUAL(3, convert("11")); }

static void test_binary_100_is_decimal_4(void) { TEST_ASSERT_EQUAL(4, convert("100")); }

static void test_binary_1001_is_decimal_9(void) { TEST_ASSERT_EQUAL(9, convert("1001")); }

static void test_binary_11010_is_decimal_26(void) { TEST_ASSERT_EQUAL(26, convert("11010")); }

static void test_binary_10001101000_is_decimal_1128(void) {
    TEST_ASSERT_EQUAL(1128, convert("10001101000"));
}

static void test_binary_ignores_leading_zeros(void) { TEST_ASSERT_EQUAL(31, convert("000011111")); }

static void test_2_is_not_a_valid_binary_digit(void) { TEST_ASSERT_EQUAL(INVALID, convert("2")); }
