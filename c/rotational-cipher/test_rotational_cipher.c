...
static void test_rotate_a_by_0_same_output_as_input(void) { test_rotate("a", "a", 0); }

static void test_rotate_a_by_1(void) { test_rotate("b", "a", 1); }

static void test_rotate_a_by_26_same_output_as_input(void) { test_rotate("a", "a", 26); }

static void test_rotate_m_by_13(void) { test_rotate("z", "m", 13); }

static void test_rotate_n_by_13_with_wrap_around_alphabet(void) { test_rotate("a", "n", 13); }
