...
static void check_personal_top_three(const int32_t *expected, size_t expected_len,
                                     const int32_t *scores, size_t scores_len) {
...
static void test_personal_top_three_from_a_list_of_scores(void) {
    ...
    check_personal_top_three(expected, ARRAY_SIZE(expected), scores, ARRAY_SIZE(scores));
}
